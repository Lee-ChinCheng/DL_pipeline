...
# Return generator #add input pram, data_dir, defined in run_train.py
def load_data(data_dir, split, fold_num, input_num, batch_size=1, method='Baseline', nor_mode=0, z_mean=None, z_std=None):
    print('- - data_dir  from  data_processor.py - -')
    print(data_dir)
...
# Return generator
def load_data_v2(input_csv, split, fold_num, input_num, batch_size=1, method='Baseline', nor_mode=0, z_mean=None, z_std=None):
